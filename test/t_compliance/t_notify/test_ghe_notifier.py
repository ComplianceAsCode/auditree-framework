...
class GHENotifierTest(unittest.TestCase):
    ...
    @patch('compliance.notify.get_config')
    def test_notify_summary_issue_day_rotation_0(
    ...
    @patch('compliance.notify.datetime')
    @patch('compliance.notify.get_config')
    def test_notify_summary_issue_day_rotation_1(
        self, get_config_mock, datetime_mock
    ):
    ...
    @patch('compliance.notify.datetime')
    @patch('compliance.notify.get_config')
    def test_notify_summary_issue_week_rotation_0(
        self, get_config_mock, datetime_mock
    ):
    ...
    @patch('compliance.notify.datetime')
    @patch('compliance.notify.get_config')
    def test_notify_summary_issue_week_rotation_1(
        self, get_config_mock, datetime_mock
    ):
    ...
    @patch('compliance.notify.datetime')
    @patch('compliance.notify.get_config')
    def test_notify_summary_issue_year_rotation_0(
        self, get_config_mock, datetime_mock
    ):
    ...
    def test_add_issue_to_project_invalid_column(self, get_config_mock):
        ...
        self.add_card_mock.assert_not_called()
        notifier.logger.warning.assert_called_once_with(
            'Column invalid-column not found '
            'in valid-project project, foo/bar repo'
        )
