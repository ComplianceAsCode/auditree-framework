...
class ComplianceFixerTest(unittest.TestCase):
    ...
    def setUp(self, config_mock):
        ...
        compliance_check1 = build_compliance_check_obj(
            'Dummy1Check',
            'dummy1',
            'Report for dummy1', ['test_dummy1_test1'],
            True
        )
        compliance_check2 = build_compliance_check_obj(
            'Dummy2Check',
            'dummy2',
            'Report for dummy2', ['test_dummy2_test1'],
            True
        )
        compliance_check3 = build_compliance_check_obj(
            'Dummy3Check',
            'dummy3',
            'Report for dummy3', ['test_dummy3_test1', 'test_dummy3_test2'],
            True
        )
        compliance_check4 = build_compliance_check_obj(
            'Dummy4Check',
            'dummy4',
            'Report for dummy4', ['test_dummy4_test1'],
            False
        )
        ...
        self.dry_run_fixer = Fixer(
            results_full, dry_run=True, out=self.dry_run_out
        )
